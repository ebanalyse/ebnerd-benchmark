# BEHAVIORS
DEFAULT_IMPRESSION_TIMESTAMP_COL = "first_page_time"  # => impression_time
DEFAULT_SCROLL_PERCENTAGE_COL = "scroll_percentage"
DEFAULT_CLICKED_ARTICLES_COL = "list_destination"  # article_ids_clicked
DEFAULT_INVIEW_ARTICLES_COL = "article_ids"  # => article_ids_inview
...
# ARTICLES
DEFAULT_ARTICLE_PUBLISHED_TIMESTAMP_COL = "published"  # published_time
DEFAULT_ARTICLE_MODIFIED_TIMESTAMP_COL = "row_time"  # last_modified_time
